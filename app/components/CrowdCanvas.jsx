...
const peeps = "/all-peeps.png";

export function CrowdCanvas({ src = peeps, rows = 15, cols = 7 }) {
  ...
  useEffect(() => {
    ...
    const config = {
      src: Array.isArray(resolvedSrc) ? resolvedSrc : [resolvedSrc],
      rows,
      cols,
    };
  ...
  return (
    <canvas ref={canvasRef} className="absolute bottom-0 h-full w-full pointer-events-none z-10" />
  );
}
