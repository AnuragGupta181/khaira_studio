  ...
  },
  {
    ...
    content: (
      <div className="bg-slate-50 border border-gray-200 rounded-xl p-5 space-y-2 text-sm">
        ...
        <p className="text-gray-600">Official Email: <a href="mailto:admin@khairadigital.com" className="text-blue-600 hover:underline font-medium">admin@khairadigital.com</a></p>
      </div>
    ),
  },
  {
